...
plt.title('(Before) Histogram of B Component for whole image')
...
plt.title('(After) Histogram of R Component for whole image')
...
plt.title('(After) Histogram of R Component in 3rd Quadrant')
